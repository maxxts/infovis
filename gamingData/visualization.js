...
var games_data = [
	...
	{"Title":"Monaco","HoursPlayed":1,"Release":2013,"Aquired":"22-06-2014","Beta":"Release","Type":"Action Stealth","Finished":0,"Replayed":5,"Progress":0,"AchUnlocked":0,"AchTotal":0,"Mode":"Multiplayer","Platform":"PC","App":"Steam","Payment":"Purchased","Digital":1,"Discount":0,"PreOrder":0},
...
rowChartYears
        ...
        .ordinalColors(['#AB3629','#299EAB', '#1E9E08', '#363230'])
        .elasticX(true);
...
pieChartMode
		...
		.legend(dc.legend())
	    .renderLabel(false)
	    .ordinalColors(['#1E9E08','#299EAB', '#AB3629']);
